...
export default function Hero() {
    ...
    return (
        <div className="pt-32 px-16 sm:px-24 mt-5" id="hero">
            ...
            <h3 className="text-start text-2xl pt-3 font-light mt-4">Software Developer</h3>
            <ul className="pt-5 text-4xl leading-10 space-y-4 font-semibold" id="hero-links">
