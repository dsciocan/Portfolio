...
export default function About() {
    ...
    <div className="bg-bg-light py-14 lg:flex justify-around items-center">
        ...
        <div className="text-xl font-normal sm:px-24 px-10 text-bg-dark">
            <p>I am a software developer who enjoys creating things, especially if they solve a practical problem or look nice. </p>
            <br/>
            ...
            <br/>
            <p>For the past year, I have been learning how to best and solve real world problems and what I can bring to the industry, and am excited for any chance to contribute my skillset where it is needed, and keep improving along the way!</p>
        </div>
    </div>
    )
